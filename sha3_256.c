...
void sha3_256(unsigned char *d, unsigned int s, const unsigned char *m,
	  unsigned int l);
	  ...
	  unsigned int l)
{
	...
	*/
	unsigned char **string_div = (unsigned char **)calloc(n,sizeof(unsigned char*)); //n pointer because we need n substrings
